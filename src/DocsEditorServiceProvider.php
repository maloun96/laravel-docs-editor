...
use Maloun96\DocsEditor\Http\Middleware\AuthorizeDocsEditor;
...
final class DocsEditorServiceProvider extends ServiceProvider
{
    ...
    {
        $prefix = config('docs-editor.route.prefix', 'admin/docs');

        Route::middleware(['web', AuthorizeDocsEditor::class])
            ->prefix($prefix)
            ->name('docs-editor.')
            ->group(function () {
